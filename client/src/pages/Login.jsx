  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
      <form className="max-w-md w-full text-center border border-gray-200 rounded-2xl p-8 bg-white shadow-xl">
        <h1 className="text-gray-900 text-3xl font-semibold">Welcome Back</h1>
        ...
        <button
          type="submit"
          className="mt-6 w-full h-12 rounded-full text-white font-medium bg-indigo-500 hover:bg-indigo-600 transition-all shadow-md hover:shadow-lg"
        >
          Login
        </button>
        ...
        <p className="text-gray-500 text-sm mt-6">
          ...
          <a className="text-indigo-500 font-medium hover:underline" href="#">
            Sign up
          </a>
        </p>
      </form>
